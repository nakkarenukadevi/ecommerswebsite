...
const GirlsDress = () => {
    ...
    return (
        ...
        <div className='py-10 grid grid-cols-5 gap-4 mx-20 ' >{Storedata.kids.girls.map((item) => {
            return <Link to={"girlsdressdata/" + item.id}><div className='mt-20 shadow-lg p-4  rounded-xl  grid justify-center items-center' key={item.id}>
